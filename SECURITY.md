...
`phionyx-langchain-langgraph` is a set of LangChain / LangGraph adapters that emit Phionyx runtime-evidence records. It is **alpha / experimental** software. Its value depends on its
...
**founder@phionyx.ai** with `[SECURITY] phionyx-langchain-langgraph` in the subject. Please do not open a public
issue or PR for a suspected vulnerability until it has been triaged.

Include, where you can: the version (`pip show phionyx-langchain-langgraph`), a minimal reproduction, and what
